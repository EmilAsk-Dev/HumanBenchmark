    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChimpAttemptDetails", x => x.AttemptId);
                    table.ForeignKey(
                        name: "FK_ChimpAttemptDetails_Attempts_AttemptId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Posts_Attempts_AttemptId",
                        column: x => x.AttemptId,
                        principalTable: "Attempts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "ReactionAttemptDetails",
                columns: table => new
                {
                    AttemptId = table.Column<long>(type: "bigint", nullable: false),
                    BestMs = table.Column<int>(type: "int", nullable: false),
                    AvgMs = table.Column<int>(type: "int", nullable: false),
                    Attempts = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReactionAttemptDetails", x => x.AttemptId);
                    table.ForeignKey(
                        name: "FK_ReactionAttemptDetails_Attempts_AttemptId",
                        column: x => x.AttemptId,
                        principalTable: "Attempts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SequenceAttemptDetails", x => x.AttemptId);
                    table.ForeignKey(
                        name: "FK_SequenceAttemptDetails_Attempts_AttemptId",
                        column: x => x.AttemptId,
                        principalTable: "Attempts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TypingAttemptDetails", x => x.AttemptId);
                    table.ForeignKey(
                        name: "FK_TypingAttemptDetails_Attempts_AttemptId",
                        column: x => x.AttemptId,
                        principalTable: "Attempts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Likes_ExactlyOneTarget", "([PostId] IS NOT NULL AND [CommentId] IS NULL) OR ([PostId] IS NULL AND [CommentId] IS NOT NULL)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attempts_Game_Value",
                table: "Attempts",
                columns: new[] { "Game", "Value" });

            migrationBuilder.CreateIndex(
                name: "IX_Attempts_UserId_Game_CreatedAt",
                table: "Attempts",
                columns: new[] { "UserId", "Game", "CreatedAt" });
