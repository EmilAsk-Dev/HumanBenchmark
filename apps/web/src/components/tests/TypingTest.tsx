...
export function TypingTest({ onComplete }: TypingTestProps) {
  ...
  const calculateWPM = useCallback(
    (typedText: string, textToType: string, testDuration: number) => {
      let correctChars = 0;
      ...
      <div className="flex flex-col items-center justify-center min-h-screen p-6 animate-slide-up bg-background">
        ...
        <div className="text-center">
          ...
          <p className="text-muted-foreground mb-8 max-w-sm">
            Type the words as fast and accurately as you can. Your WPM will be
            calculated based on correct characters.
          </p>
